      ...
      <div className='flex flex-col w-[954px] h-[712px] rounded-[14px] items-start shadow border border-gray-scale-8 px-[25px]'>
        ...
        <div className='items-start'>
          <label
            ...
            className='flex flex-col w-[154px] h-[154px] ml-[5px] mt-[8px] items-center justify-center rounded-[14px] border-dashed border border-gray-scale-5 cursor-pointer'
          >
            <input
              type='file'
              id='image-upload'
