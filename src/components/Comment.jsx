  ...
  return (
    <div className='border-b border-gray-scale-7'>
      <div className='w-[884px] h-[146px] py-[10px]'>
        <div className='flex my-[10px]'>
          ...
          <div className='flex flex-col ml-[10px]'>
            <div className='flex justify-between'>
              <p className='text-gray-scale-1 font-bold'>{comment.nickname}</p>
              <button type="button" className='text-[15px] font-normal text-[#808593] hover:text-gray-scale-1' onClick={() => deleteComment(comment.commentId)} >삭제하기</button>
            </div>
        ...
        <p className='text-[18px] leading-[26px] tracking-[0.04em]'>{comment.content}</p>
